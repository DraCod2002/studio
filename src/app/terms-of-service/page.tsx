    ...
    <PageWrapper>
      <Card className="shadow-lg">
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <p>Por favor, lee estos Términos de Servicio ("Términos", "Términos de Servicio") cuidadosamente antes de usar el sitio web Xstrees y sus servicios (el "Servicio") operado por Xstrees ("nosotros", "nos" o "nuestro").</p>
          ...
          <p>Xstrees proporciona información y herramientas relacionadas con el manejo del estrés, incluyendo un chatbot de apoyo emocional y un test de nivel de estrés. Estos servicios son solo para fines informativos y educativos.</p>
          ...
          <p><strong>Si estás experimentando una emergencia médica o crisis, llama a tu número de emergencia local (por ejemplo, 112 en muchos países de Europa, 911 en EE. UU.) o dirígete a la sala de emergencias más cercana inmediatamente.</strong></p>
          ...
          <p>El Servicio y su contenido original, características y funcionalidad son y seguirán siendo propiedad exclusiva de Xstrees y sus licenciantes. El Servicio está protegido por derechos de autor, marcas registradas y otras leyes tanto de tu jurisdicción como de países extranjeros.</p>
          ...
          <p>Si tienes alguna pregunta sobre estos Términos, por favor contáctanos en [Correo electrónico de marcador de posición: soporte@xstrees.app].</p>
        </CardContent>
      </Card>
    </PageWrapper>
  );
